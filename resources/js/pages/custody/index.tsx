...
export default function CustodyRecords({ cameras, records, search = '', uploadConfig }: any) {
    ...
    return (
        <>
            ...
            <div className="space-y-6 p-6">
                <div>
                    <h1 className="text-2xl font-bold text-white">CCTV Registration and Verification</h1>
                ...
                <div className="grid gap-6 lg:grid-cols-[420px_1fr]">
                    {canRegister && <Card className="border-white/10 bg-gray-900/80">
                        <CardHeader>
                            <CardTitle className="flex items-center gap-2 text-white"><Upload className="h-5 w-5 text-[#AD9334]" /> Register CCTV</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <form className="space-y-4" onSubmit={submit}>
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="footage">CCTV video file</Label>
                                    ...
                                    {uploadConfig && (
                                        <p className="text-xs text-gray-500">
                                            PHP limits: upload {uploadConfig.maxFileSize}, post {uploadConfig.postMaxSize}, memory {uploadConfig.memoryLimit}.
                                        </p>
                                    )}
                                </div>
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="recording_url">Existing relative storage path</Label>
                                    <Input id="recording_url" value={form.data.recording_url} onChange={(e) => form.setData('recording_url', e.target.value)} placeholder="cctv-footage/recording.mp4" />
                                </div>
                                <div className="space-y-2">
                                ...
                                <Button type="submit" disabled={form.processing} className="w-full">
                                    <ShieldCheck className="mr-2 h-4 w-4" /> Register and Commit
                                </Button>
...
CustodyRecords.layout = (props: any) => ({ breadcrumbs: [{ title: 'CCTV Register', href: '/custody-records' }] });
