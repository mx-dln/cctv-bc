...
export default function AuthSplitLayout({
    ...
    return (
        <div className="relative grid h-dvh flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
            <div className="relative hidden h-full flex-col bg-[#0F1020] p-10 text-white lg:flex dark:border-r">
                <Link href={home()} className="relative z-20 flex items-center text-lg font-medium">
                    <img src="/assets/logo/ficobank.png" alt="FICOBank" className="mr-3 h-8 w-auto" />
                    {name}
                </Link>
            </div>
